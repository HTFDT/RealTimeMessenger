...
internal class ServicesManager(IRepositoryManager repoManager, IIdentityConnectionService identityConnectionService) : IServicesManager
{
    ...
    private readonly Lazy<IMembershipsServiceWrapper> _lazyMemberships = new(() => new MembershipsServiceWrapper(new MembershipsServiceEnsureRightsDecorator(new MembershipsService(repoManager, identityConnectionService), repoManager), repoManager));
